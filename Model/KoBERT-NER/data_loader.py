...
from dataset_compile import main as preprocessor
...
class WhynotNerProcessor(object):
    """Processor for the Naver NER data set """
    ...
    @classmethod
    def _read_file(cls, input_file):
        """words and label as list"""
        #print(preprocessor(input_file))
        return preprocessor(input_file)
    ...
    def get_examples(self, mode):
        ...
        file_to_read = None
        if mode == 'train':
            file_to_read = "origin_klue/klue-ner-v1.1_train.tsv"
        elif mode == 'dev':
            file_to_read = self.args.dev_file
        elif mode == 'test':
            file_to_read = "origin_klue/klue-ner-v1.1_dev.tsv"
